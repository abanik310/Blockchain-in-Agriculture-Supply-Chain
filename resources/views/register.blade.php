...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <p class="text text-bold text-success" style="text-align: center; text-transform: uppercase; color: lightgreen">
          {!! Session::get('success') !!}
      </p>
      @endif
            ...
            <div class="card">
              ...
              <div class="card-body login-card-body">
                ...
                <h3 style="text-align:center;" class="card-title">Sign in to start your session</h3>
                 --}}
                 <p style="font-size: xx-large" class="login-box-msg"><b>Register a new membership</b></p>
